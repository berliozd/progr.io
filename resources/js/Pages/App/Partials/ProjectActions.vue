...
<template>
  <div class="flex flex-row justify-end items-center pr-6 sm:pr-8 py-3" v-if="project && project.id">
    <SavedLabel/>
    <div class="flex flex-row items-center space-x-3 h-fit text-base-content/60">
      <div class="tooltip" data-tip="Export as CSV">
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-sheet hover:cursor-pointer hover:text-primary transition-colors duration-150" @click="exportProject( project.id, 'app.projects.csv')">
      ...
      <div class="tooltip" data-tip="Export as PDF">
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-file-text hover:cursor-pointer hover:text-primary transition-colors duration-150"
      ...
      <div class="w-px h-5 bg-base-300"></div>
      <div class="tooltip" data-tip="Presentation view">
        <a :href="route('app.projects.presentation', {id: project.id})" target="_blank"
