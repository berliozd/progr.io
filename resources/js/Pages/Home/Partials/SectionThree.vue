...
<template>
    ...
    <section class="text-center md:p-12 p-6">
        ...
        <p class="max-w-xl mx-auto text-lg opacity-80 leading-relaxed mb-12 md:mb-20">
            ...
            <br>
            That's where our tool comes in - it helps you keep track of your ideas, follow their progress, and turn them
            into
            successful
            projects.
        </p>
        ...
        <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
            ...
            <div class="w-full md:w-48 flex flex-col gap-2">
                <span class="text-4xl">🤬</span>
                <p class="font-bold">I really need to organize myself</p>
            </div>
        </div>
    </section>
</template>
